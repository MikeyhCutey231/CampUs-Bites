    ...
    <div class="right-container">
        <div class="head-content">
            <div class="Menu-name">
                ...
                <p style="margin-bottom: 0;">Cook</p>
            </div>
            <!-- Main Search Bar -->
                        ...
                        <div class="content-2 d-flex">
                            <div class="col-12 table-container">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
                                    $employeeData = $userDataInstance->getEmployeeDataCook();
                        ...
                        <div class="modalSixRowInfo">
                            <div class="modalPosition">
                                ...
                                <select id="position" name="position" required>
                                    ...
                                    $cashierOption = '<option value="emp_cook" selected>Cook</option>';
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#live_search").keyup(function() {
            ...
            if (input !== "") {
                $.ajax({
                    url: "../../Admin/functions/livesearch_cook.php",
                    method: "POST",
                    data: {
                        input: input
                    },
