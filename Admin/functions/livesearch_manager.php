...
include('../../config.php');
include '../admin_functions/UserData.php';
...
WHERE (U_FIRST_NAME LIKE '{$input}%' OR U_MIDDLE_NAME LIKE '{$input}%' OR U_LAST_NAME LIKE '{$input}%')
  AND user_roles.ROLE_CODE = 'adm_manager';
";
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $positionText = ($row["ROLE_CODE"] == 'adm_manager') ? "Manager" : $row["ROLE_CODE"];

                            echo "<tr>";
                            echo "<td><img style='border-radius: 50px;' src='" . 'upload/' . $row['U_PICTURE'] . "' width='42', height='42'></td>";                            echo "<td>" . $lastName . "</td>";
