...
<head>
    ...
    <link rel="stylesheet" href="../../Courier/courier_css/courier-Activeorders.css">
</head>
<body>
    <div class="wrapper">
                 ...
                 <table class="table">
                     ...
                     <tbody>
                        <?php
                          ...
                          $data = $orderData->getOrders();
                          $orderData->renderOrders($data);
                        ?>
                     </tbody>
                   </table>
                </div>
    ...
    <script>
            ...
            $('.viewOrder').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../functions/activCourierIdHandler.php',
