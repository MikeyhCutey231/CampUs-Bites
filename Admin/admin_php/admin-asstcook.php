    ...
    <div class="right-container">
        <div class="head-content">
            <div class="Menu-name">
                ...
                <p style="margin-bottom: 0;">Assistant Cook</p>
            </div>
            <!-- Main Search Bar -->
                        ...
                        <div class="content-2 d-flex">
                            <div class="col-12 table-container">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
                                    $employeeData = $userDataInstance->getEmployeeDataAsstCook();
                        ...
                        <div class="modalSixRowInfo">
                            <div class="modalPosition">
                                ...
                                <select id="position" name="position" required>
                                    ...
                                    $cashierOption = '<option value="emp_asst_cook" selected>Assistant Cook</option>';
                                    ...
                                    <option value="emp_cshr">Cashier</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#live_search").keyup(function() {
            ...
            if (input !== "") {
                $.ajax({
                    url: "../../Admin/functions/livesearch_asstcook.php",
                    method: "POST",
                    data: {
                        input: input
                    },
                ...
                $.ajax({
                    url: "../admin_functions/livesearch_asstcook.php",
                    method: "POST",
                    data: {
                        input: ""
