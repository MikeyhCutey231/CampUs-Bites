<?php
    ...
    if (isset($_POST["claimBtn"])) {
        $claimedOrder = "UPDATE online_order SET ORDER_STATUS_ID = '3', COURIER_ID  = '$userID' WHERE OL_CART_ID = '$cartID'";
        mysqli_query($conn, $claimedOrder);

        // Unset the oldCartID
        unset($_SESSION["cartID"]);

        header("Location: courier-Orderlist.php");
...
<head>
    ...
    <link rel="stylesheet" href="../../Courier/courier_css/vieworderList.css">
</head>
<body>
    <div class="wrapper">
        ...
        <div class="right-container">
            <div class="head-content">
                <div class="Menu-name">
                    ...
                    <p style="margin-bottom: 0;">Order List</p>
                </div>
               ...
               <div class="mainRight-container">
                    ...
                    <div class="courier-container">
                        <p class="customerText-head">Courier</p>
                            ...
                            <?php
                                $orderData = new viewOrderListData($conn);
                                $data = $orderData->courierInfo();
                                $orderData->renderCourierInfo($data);
                            ?>
                    </div>
               </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            $("#claimBtn").click(function() {
                ...
                $.ajax({
                    url: '../functions/orderListClaimHandler.php',
                    ...
                    success: function(data) {
                        if (data.status === "success") {
                            ...
                            console.error('Error claiming order:', data.message);
