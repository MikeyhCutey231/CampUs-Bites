    ...
    <div class="right-container">
        <div class="head-content">
            <div class="Menu-name">
                ...
                <p style="margin-bottom: 0;">Courier</p>
            </div>
            <!-- Main Search Bar -->
                        ...
                        <div class="content-2 d-flex">
                            <div class="col-12 table-container">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
                                    $employeeData = $userDataInstance->getEmployeeDataCourier();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form action="../../Admin/functions/add-Employee.php" id="employee-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="editRight-container">
                        ...
                        <div class="modalSecondRowInfo">
                            ...
                            <div class="modalPhonenumber">
                                <p>* Phone Number</p>
                                <input id="numericInput" name="phone_number" type="text" required minlength="11" maxlength="11">
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#live_search").keyup(function() {
            ...
            if (input !== "") {
                $.ajax({
                    url: "../../Admin/functions/livesearch_courier.php",
                    method: "POST",
                    data: {
                        input: input
                    },
