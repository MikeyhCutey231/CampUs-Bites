...
<head>
    ...
    <link rel="stylesheet" href="../../Courier/courier_css/courier-viewtransaction.css">
</head>
<body>
    <div class="wrapper">
        ...
        <div class="right-container">
            ...
            <div class="main-content">
               ...
               <div class="orderInfo-container">
                        <?php
                            $orderData = new viewOrderListData($conn);
                            $data = $orderData->orderTransactionHeaderDetails();
                            $orderData->renderTransactionOrdersDetails($data);
                        ?>
                    </div>
                    ...
                    <table>
                            ...
                            <?php
                                $orderData = new viewOrderListData($conn);
                                $data = $orderData->productTransactionCartDetails();
                                $orderData->renderTransactionCartProdDetails($data);
                            ?>
                        </table>
                    </div>
                    <div class="payment-container">
                        ...
                        <div class="paymentSum-container">
                            <?php
                                $orderData = new viewOrderListData($conn);
                                $data = $orderData->paymentTransactionProdDetails();
                                $orderData->renderTransactionPaymentDetails($data);
                            ?>
                        </div>
                    </div>
               </div>
               ...
               <div class="customer-container">
                            <?php
                                $orderData = new viewOrderListData($conn);
                                $data = $orderData->customerRenderInformation();
                                $orderData->renderTransactionCustomerInfo($data);
                            ?>
                    </div>
