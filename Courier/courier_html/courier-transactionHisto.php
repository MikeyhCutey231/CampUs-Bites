...
<head>
    ...
    <link rel="stylesheet" href="../../Courier/courier_css/courier-TransactionHisto.css">
</head>
<body>
    <div class="wrapper">
        ...
        <div class="right-container">
            <div class="head-content">
                <div class="Menu-name">
                    ...
                    <p style="margin-bottom: 0;">Transaction History</p>
                </div>
            ...
            <div class="main-content">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-11 mt-4 searchContainer">
                            <div class="content-1 p-2 d-flex searchBox">
                                <div class="searchbar justify-content-start d-flex col-5">
                                <span class="input-group-text col-7">
                                    <img src="../../Icons/searchgreen.svg" alt="searchIcon" width="18px">
                                    <input type="text" name="fname" placeholder="Search name..." id="searchItem">
                                </span>
                            </div>
                            <div class="yawa" style="width: fit-content; display: flex; margin-left: 250px;">
                                    <div class="date1" style="display:flex; align-items:center;">
                                        <div class="sortContainer" style="margin-top: 8px;">
                                                <h6 class="sort">From:</h6>
                                        </div>
                                        <div class="sortDropdown mt-1" style="margin-left: 6px; margin-right: 6px;">
                                                <input type="date" id="fromDate">
                                        </div>
                                    </div>


                                    <div class="date2" style="display:flex; align-items:center;">
                                            <div class="sortContainer" style="margin-top: 8px;" >
                                                <h6 class="sort">To</h6>
                                            </div>
                                    ...
                                    <div class="filterBtns">
                                        <button class="refresh" onclick="resetPage()">Reset</button>
                                    </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-11 mt-3 mainTransactionTable">
                            <div class="content-2 d-flex tableDiv">
                                <div class="col-12 table-container">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th scope="col" style="color: #555; font-weight: normal;">Transaction Date</th>
                                            <th scope="col" style="color: #555; font-weight: normal;">Customer Name</th>
                                            <th scope="col" style="color: #555; font-weight: normal;">Order Number</th>
                                            <th scope="col" style="color: #555; font-weight: normal;">Total Amount</th>
                                            <th scope="col" style="color: #555; font-weight: normal;">Action</th>
                                        </tr>
                                        </thead>
                                        <tbody id="dateTable">
                                            <?php
                                                $employeeData = new DateHandler($conn);
        ...
        $(document).ready(function(){
                $('#searchItem').on('input', function(){
                    ...
                    if (searchValue.trim() !== '') {
                        ...
                        $.post('../functions/liveSearchTransaction.php', { name: searchValue }, function(data) {
                            $("#dateTable").html(data);
                        });
                    } else {
                        // If the search value is empty, display all products (adjust this part based on your requirements)
                        $.post('../functions/liveSearchTransaction.php', { name: '' }, function(data) {
                            $("#dateTable").html(data);
                        });
                    }
                });
